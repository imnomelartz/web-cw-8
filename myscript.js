...
let iceCream = [`فراوله`, `كاكاو`, `فانيليا`, `موز`];
...
let IIceCream = [`فراوله`, `كاكاو`, `فانيليا`, `موز`, `اناناس`, `بلوبيري`];
function MyIceCream() {
  for (let i = 0; i < IIceCream.length; i++) {
    console.log(IIceCream[i]);
  }
}
MyIceCream();
// --------------------------------- 🔥 بونص ------------------------------------
...
let x = 0;
while (x < IIceCream.length) {
  console.log(IIceCream[x]);
  x++;
}
